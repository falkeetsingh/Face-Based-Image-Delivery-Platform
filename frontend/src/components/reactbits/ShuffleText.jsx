...
const ShuffleText = ({
    ...
    threshold = 0.1,
    rootMargin = '-100px',
    tag = 'span', /* Changed from p to span for inline flow */
    ...
    useGSAP(
        () => {
            ...
            // Since we use a custom scroll container in Mosaic, normal ScrollTrigger to window won't fire.
            // We will just initialize the component directly.
            create();
